            ...
            <div class="bodySize ps-5 ms-3 ms-lg-0 row d-flex">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="my-3">
                        ...
                        <asp:TextBox ID="txtTiempoTotal" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="my-3">
                        <div><label for="txtIdEmplado">Id Empleado:</label></div>
                        <asp:TextBox ID="txtIdEmplado" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="my-3">
                        ...
                        <asp:TextBox ID="txtSubtotal" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="my-3">
                        <div><label for="txtIVA">IVA:</label></div>
                        <asp:TextBox ID="txtIVA" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="my-3">
                        <div><label for="txtTotal">Total:</label></div>
                        <asp:TextBox ID="txtTotal" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="my-3">
                        <div><label for="txtPago">Pago:</label></div>
                        <asp:TextBox ID="txtPago" runat="server" Width="90%" ViewStateMode="Disabled" AutoPostBack="true" onkeypress="return validaNumeros(event);"></asp:TextBox>
                    </div>
                    <div class="my-3">
                        <div><label for="txtCambio">Cambio:</label></div>
                        <asp:TextBox ID="txtCambio" runat="server" Width="90%" ViewStateMode="Disabled" Enabled="false"></asp:TextBox>
                    </div>
                </div>
                <div class="mt-2 pe-5 text-end">
                    <asp:Button Text="Regresar" runat="server" class="btnForm mx-1" OnClick="btnRentPrincipal_Click" />
                    <asp:Button Text="Finalizar" runat="server" class="btnFormAct mx-1" OnClick="btnFinalRenta_Click" />
                </div>
            </div>
        </div>
